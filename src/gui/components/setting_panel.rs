    ...
    ComboBox::new("input_type", fl!("setting-panel-label-input-type"))
        ...
        .show_ui(ui, |ui| {
            if ui
                ...
                .on_hover_text(fl!("setting-panel-hover-input-postmessage"))
                .clicked()
            {
            ...
            if ui
                ...
                .on_hover_text(fl!("setting-panel-hover-input-sendinput"))
                .clicked()
            {
...
fn show_select_loop_speed(ui: &mut Ui, app: &mut MyApp) {
    ...
    let combo = ComboBox::new("loop_per_second", fl!("setting-panel-label-loop-per-second"))
        .selected_text(text)
        .show_ui(ui, |ui| {
            if ui
                .selectable_value(&mut app.setting.loop_per_second, 5, fl!("setting-panel-loop-per-second-very-low"))
                .on_hover_text("5 loops per second")
                .clicked()
            {
            ...
            if ui
                ...
                .on_hover_text("10 loops per second")
                .clicked()
            {
            ...
            if ui
                ...
                .on_hover_text("15 loops per second")
                .clicked()
            {
            ...
            if ui
                ...
                .on_hover_text("25 loops per second")
                .clicked()
            {
            ...
            if ui
                ...
                .on_hover_text("60 loops per second")
                .clicked()
            {
    ...
    combo.response.on_hover_text(fl!("setting-panel-hover-loop-per-second"));
}

fn show_select_threshold(ui: &mut Ui, app: &mut MyApp) {
    let text = match app.setting.threshold {
        t if t >= 0.03 => fl!("setting-panel-threshold-very-high"),
        t if t >= 0.02 => fl!("setting-panel-threshold-high"),
        t if t >= 0.01 => fl!("setting-panel-threshold-medium"),
        _ => fl!("setting-panel-threshold-low"),
    };
    let combo = ComboBox::new("threshold", fl!("setting-panel-label-threshold"))
        .selected_text(text)
        .show_ui(ui, |ui| {
            if ui
                .selectable_value(&mut app.setting.threshold, 0.03, fl!("setting-panel-threshold-very-high"))
                .on_hover_text("0.03")
                .clicked()
            {
            ...
            if ui
                .selectable_value(&mut app.setting.threshold, 0.02, fl!("setting-panel-threshold-high"))
                .on_hover_text("0.02")
                .clicked()
            {
    ...
    combo.response.on_hover_text(fl!("setting-panel-hover-threshold"));
}
