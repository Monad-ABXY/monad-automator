...
pub fn run_gui() -> eframe::Result<(), eframe::Error> {
    ...
    run_native(
        ...
        Box::new(|cc| {
            ...
            if setting.theme == crate::core::Theme::Dark {
                ctx.set_theme(egui::Theme::Dark);
            } else if setting.theme == crate::core::Theme::Light {
...
impl eframe::App for MyApp {
    fn update(&mut self, ctx: &egui::Context, _frame: &mut eframe::Frame) {
        ...
        egui::CentralPanel::default().show(ctx, |ui| {
            let cell_color = if ui.visuals().dark_mode { Color32::from_black_alpha(80) } else { Color32::from_black_alpha(40)};
            // menu
            components::menu_bar::menu(ctx, ui, self);
                ...
                .vertical(|mut strip| {
                    ...
                    strip.strip(|builder| {
                        builder.sizes(Size::remainder(), 2).horizontal(|mut strip| {
                            ...
                            strip.cell(|ui| {
                                ui.painter()
                                    .rect_filled(ui.available_rect_before_wrap(), 8.0, cell_color);
        ...
        if self.show_variables_viewport {
            components::variables_viewport::show_variables_viewport(ctx, self);
        }
